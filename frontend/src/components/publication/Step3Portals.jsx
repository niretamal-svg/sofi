...
export default function Step3Portals() {
  ...
  const autoSelect = () => {
    ...
    toast.success(t('applySuggestedSelection'));
  };
      ...
      <div>
        <div className="card" style={{ overflow: 'visible' }}>
          <div className="card-header" style={{ borderTopLeftRadius: '11px', borderTopRightRadius: '11px' }}>
            ...
            <button className="btn btn-sm btn-ai" onClick={autoSelect}>✦ {t('smartAISelection')}</button>
          </div>
