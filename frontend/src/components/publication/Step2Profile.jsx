...
export default function Step2Profile() {
  ...
  const { selectedVacancy, setSelectedProfile, setStep } = usePublicationStore();
  ...
  const handleGenerateAI = async () => {
    ...
    try {
      ...
      setValue('descripcion', result.descripcion || 'Descripcion generada para atraer candidatos adecuados al puesto.');
      setValue('requisitos', 'Experiencia relacionada\nActitud de servicio\nDisponibilidad de horario');
